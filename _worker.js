// Paste your Prerender.io token below (free tier: 250 pages)
const PRERENDER_TOKEN = 'PASTE_YOUR_PRERENDER_TOKEN_HERE';
...
export default {
  async fetch(request, env) {
    ...
    // 3. Prerender for bots (only if token is set)
    if (PRERENDER_TOKEN !== 'PASTE_YOUR_PRERENDER_TOKEN_HERE' && isBot(userAgent)) {
