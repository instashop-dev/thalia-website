...
keyResults:
  - metric: 15%
    label: Revenue growth from affiliate-linked listings
    accent: true
  - metric: 25%
    label: Increase in affiliate clicks
    accent: true
  - metric: 5 / 5
...
helpedWith:
  ...
  - Cross-promote music catalogue
  - Increase product visibility
quote: We sell merchandise for a band and it allows us to link to the band's albums on websites which sell them.
