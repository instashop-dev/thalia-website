...
keyResults:
  - metric: 5 / 5
    label: Satisfaction & likelihood to recommend
    accent: true
  - metric: 10–25%
    label: Improvement in affiliate metrics
    accent: true
  - metric: 1–3 hrs
    label: Saved per week on manual link management
businessOutcomes:
...
recommendScore: 5
helpedWith:
  - Monetise affiliate partnerships
  - Remove manual link workarounds
  - Increase product visibility
quote: Outlink makes it so easy for me to plug in my affiliate link to any products. It works perfect in my Shopify store.
