...
export const apps: AppData[] = [
  ...
  },
  {
    slug: "pro",
    name: "Pro",
    tagline: "Schedule bulk price discounts, rollback anytime, and manage pricing with full control.",
    description: "Change prices in bulk, schedule sales and discounts in advance, and rollback to original prices instantly. Perfect for seasonal promotions at scale.",
    longDescription: "Pro Bulk Price Editor is the most powerful pricing management tool for Shopify. It lets you change prices across your entire catalog — or specific collections, tags, or product types — with percentage-based or fixed-amount adjustments. Schedule discounts to start and end at specific times (perfect for Black Friday, holiday sales, or flash promotions), and when the sale ends, rollback to original prices with a single click. Pro maintains a complete history of all price changes, so you can always revert to any previous state. Trusted by over 20,000 Shopify merchants, Pro handles pricing for stores of every size.",
    platform: "Shopify",
    ...
    featureDetails: [
      { title: "Bulk Price Editing", desc: "Select products by collection, tag, vendor, or product type and apply price changes in bulk. Increase or decrease prices by percentage, fixed amount, or set specific prices." },
      { title: "Discount Scheduling", desc: "Schedule sales to start and end at exact dates and times. Set up Black Friday, holiday, or flash sales weeks in advance and let Pro handle the execution automatically." },
      { title: "One-Click Rollback", desc: "When a sale ends, rollback all prices to their original values with a single click. No spreadsheets, no manual work — prices revert instantly across your entire catalog." },
      { title: "Smart Pricing Rules", desc: "Create rules based on collections, tags, product types, or vendors. Apply different discount percentages to different groups simultaneously." },
      { title: "Price Change History", desc: "Every price change is logged with timestamps, before/after values, and the user who made the change. Full audit trail for your pricing decisions." },
      { title: "Conflict Prevention", desc: "Pro detects overlapping schedules and conflicting rules before they cause problems. You'll never accidentally apply two discounts to the same product." },
    ],
    benefits: [
      "Save 25+ hours per week on manual price management",
      "Run complex promotional campaigns with scheduled automation",
      "Eliminate pricing errors with preview and conflict detection",
      "Full audit trail of all price changes for compliance",
      "One-click rollback means zero risk on promotional campaigns",
      "Handle stores with 100,000+ products effortlessly",
    ],
    howItWorks: [
      { step: "01", title: "Select Products", desc: "Choose which products to update — by collection, tag, vendor, or manual selection. Filter down to exactly the products you need." },
      { step: "02", title: "Set Price Rules", desc: "Apply percentage discounts, fixed amount changes, or specific prices. Schedule start and end times for automated campaigns." },
      { step: "03", title: "Execute & Rollback", desc: "Pro applies your changes automatically at the scheduled time. When the campaign ends, rollback to original prices with one click." },
    ],
    plans: [
      { name: "Free", price: "$0", period: "/month", features: ["Up to 50 products", "Basic bulk edit", "Manual rollback", "Email support"] },
      { name: "Pro", price: "$9.99", period: "/month", features: ["Up to 5,000 products", "Scheduling", "Auto-rollback", "Priority support"], highlighted: true },
      { name: "Enterprise", price: "$24.99", period: "/month", features: ["Unlimited products", "Complex rules", "Price history", "Dedicated support"] },
    ],
    reviews: [
      { rating: 5, quote: "Pro Bulk Editor saved us 20+ hours per week. Scheduling discounts is now completely automated.", author: "Raj K.", role: "Shopify Plus Merchant, India", date: "Mar 2025" },
      { rating: 5, quote: "We ran 50 simultaneous discount campaigns for Black Friday. Pro handled it all flawlessly.", author: "Jennifer W.", role: "eCommerce Director, USA", date: "Feb 2025" },
      { rating: 5, quote: "The rollback feature is a lifesaver. We can experiment with pricing without any risk.", author: "Stefan M.", role: "Store Owner, Austria", date: "Jan 2025" },
    ],
