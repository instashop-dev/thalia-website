...
const appLogos: Record<string, string> = {
  ...
  "bolt-bulk-editor": boltLogo,
  "dual-price-display": dualLogo,
  outlink: outlinkLogo,
  "robo-product-importer": roboLogo,
  "t2-product-icons": t2IconsLogo,
  shipr: shiprLogo,
  "duplicate-sku-sync": duplicateLogo,
  "sleek-gst-invoicing": sleekLogo,
  "clever-variant-images": cleverLogo,
  "super-product-badges": superLogo,
  "clean-info-tables": cleanTableLogo,
  "prime-product-badges": primeLogo,
